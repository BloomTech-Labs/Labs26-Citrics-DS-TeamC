...
@router.post('/wage_business_viz/')
async def wage_business_viz(user_queried_citystates: list):
    """
    ...
    def create_wage_plots(df, industry_list, industry_name):
        ...
        return jobs_json
    wage_json = create_wage_plots(subsetJ, industry_list, industry_list[8])
